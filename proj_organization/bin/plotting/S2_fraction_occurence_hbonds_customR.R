...
dfgen_all=cropDF(systemFile,"polyglycine","processed/hbonds_all_occurence_definedbins.tsv")
...
for (i in directories) {
    ...
    if (grepl("poly[a-z].*",i)) {
        ...
        retdf_all=cropDF(systemFile,polymer,"processed/hbonds_all_occurence_definedbins.tsv")
...
plotfunc(dfgen_all,paste0(out,'hbond_frequency_custom_all'))
