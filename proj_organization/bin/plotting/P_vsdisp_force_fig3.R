'need thorough look to change the input dataframe to the new appended form'
...
plotallad <- function(df,extractele,outapp) {
    ...
    gg <- gg + ylab("Force (nN)")
    ggsave(filename = paste0(outapp,reptype,'Fig3M_FvsD_vertical.pdf'),gg,height = 8, width= 3)
    ...
    ggsave(filename = paste0(outapp,reptype,'Fig3M_FvsD_dispav_horizontal.pdf'),gg1, height = 5, width= 14)
